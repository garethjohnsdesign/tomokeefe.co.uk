(function () {
	...
	function (_Plugin) {
	  ...
	  _createClass(Abide, [{
	    ...
	    value: function validateCheckbox(groupName) {
	      ...
	      $group.each(function (i, e) {
	        if (!valid) {
	          _this7.addErrorClasses(jquery(e));
	        } else {
	          _this7.removeErrorClasses(jquery(e));
	        }
	      });
	      return valid;
	    }
	...
	* Copyright (c) 2018 Sachin N; Licensed GPLv3 */
	...
	jquery(".navigation").hover(function(){
	  	jquery(".home__menu").removeClass("hide");
	    jquery(".home__title").addClass("hide"); 
	   	 }, function () {
	 	 jquery(".home__menu").addClass("hide");
	 	 jquery(".home__title").removeClass("hide");
	});
	...
	jquery('#testinglayout').lightGallery({
	...
	*/
	...
	jquery(".list li a").hover( function() { // Changes the .image-holder's img src to the src defined in .list a's data attribute.
